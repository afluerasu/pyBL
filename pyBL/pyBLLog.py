...
class ExperimentalLog():
    '''
    Logging is done globally throughout this API. This allows developers to add logging capability to their custom configuration by simply calling the logging instances created by this class
    '''
