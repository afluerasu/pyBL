# -*- coding: utf-8 -*-
#
# pyBL documentation build configuration file, created by
...
project = u'pyBL'
copyright = u'2013, Arman Arkilic'
...
latex_documents = [
  ('index', 'pyBL.tex', u'pyBL Documentation',
...
man_pages = [
    ('index', 'pybl', u'pyBL Documentation',
     [u'Arman Arkilic'], 1)
]
...
texinfo_documents = [
  ('index', 'pyBL', u'pyBL Documentation',
   u'Arman Arkilic', 'pyBL', 'One line description of project.',
   'Miscellaneous'),
]
